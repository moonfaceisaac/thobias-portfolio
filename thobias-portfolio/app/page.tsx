...
// import AboutMeSection from "@/components/id-card/AboutMeSection";
...
//   return (
//     <main className="min-h-screen flex flex-col items-center justify-start pb-16 bg-[#252424]">
//       {/* Top Header */}
//       <Header />

//       {/* Hero ID Card & About Me Section */}
//       <AboutMeSection
//         isUnclipped={isUnclipped}
//         onToggleUnclip={() => setIsUnclipped((prev) => !prev)}
//       />

//       {/* Main Archive Filing Folder */}
//       <FolderContainer />
//     </main>
//   );
// }
