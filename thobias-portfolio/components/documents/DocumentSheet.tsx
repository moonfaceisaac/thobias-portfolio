  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className="relative w-full mt-15"
      >
        {/* 1. COLORED FOLDER SHEET BACKING (Sits behind at z-0) */}
        <div
          className="absolute -mr-4  -inset-3 -top-10 -right-4 -bottom-4 -left-4  rounded-l-md shadow-2xl z-10 border-l border-y border-white/20"
